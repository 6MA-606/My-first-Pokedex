    ...
    <div className="bg-neutral-800 min-h-screen pt-10 pb-10 xl:p-0 flex flex-col xl:flex-row gap-6 items-center justify-center">
      ...
      <div className="flex gap-5 items-center justify-center flex-col xl:flex-row">
        <div className="flex gap-5 items-center">
          ...
          <div>
            <div
              className={`h-[30rem] w-[30rem] relative border-2 bg-neutral-700 border-neutral-600 rounded-xl`}
            >
                ...
                <div>
                  <div className="flex items-center justify-between">
                    <div className="flex items-baseline justify-center gap-2">
                      <div className="text-[3rem] text-neutral-50 font-semibold capitalize drop-shadow-lg">
