...
export const PokeButton = (props) => {
    ...
    return (
        <button type="button" className='w-24 h-40 bg-neutral-600 flex flex-col items-center justify-center rounded-lg border-2 border-neutral-700' onClick={onClick} disabled={loading}>
...
export const PokeButtonMini = (props) => {
  ...
  return (
      <button type="button" className='px-2 h-12 bg-neutral-600 flex items-center justify-between rounded-lg border-2 border-neutral-700' onClick={onClick} disabled={loading}>
