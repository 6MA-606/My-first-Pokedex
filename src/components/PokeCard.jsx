            ...
            {loading ? (
                <>
                    <div className="flex my-1 gap-1 items-center">
                        <div className="font-semibold w-[7rem] bg-neutral-600 rounded-md">&nbsp;</div>
                    </div>
                    <img className="bg-pokeball bg-center bg-no-repeat animate-spin" src={"/pokeball-bg.svg"} alt={"pokeball-bg"} />
                ...
                <>
                    ...
                    <div className="flex justify-center items-center gap-2 mb-1">
                        {pokemon?.types?.map((type) => (
                            <PokeType pokeType={type.type.name} key={type.type.name} size={0.7} />
                        ))}
                    </div>
                </>
            )}
